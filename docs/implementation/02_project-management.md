...
- [ ] アーカイブ後、一覧から消える
- [ ] アーカイブ一覧で復帰できる
- [ ] 11個目のプロジェクト作成時、1番目の色（#3B82F6）が自動割当される
- [ ] 期間切替（当日/当週/当月）で各プロジェクトの合計時間が正しく表示される
- [ ] プロジェクト一覧に最終計測日が表示される
- [ ] プロジェクト名が空の場合、「プロジェクト名を入力してください」と表示され保存できない
- [ ] 通信エラー時に「保存に失敗しました。もう一度お試しください。」と表示される

### エッジケース

- [ ] プロジェクト100件でも一覧が正しく表示される
